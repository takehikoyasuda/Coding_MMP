-- Regression for the canonical-ideal/reflexive-power BPF path.
...
assert(fullResult#"witnessType" == "non-nef positive perturbation");
print("OK canonical ideal/reflexive-power BPF fast path");
